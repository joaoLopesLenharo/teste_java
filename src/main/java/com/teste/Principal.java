...
public final class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("============================================================");
        System.out.println("  MODULO RH - Java + Maven + MVC + Service + DTO");
        System.out.println("============================================================\n");
        ...
        if ("console".equals(modo)) {
            ...
            System.out.println("============================================================");
            System.out.println(" EXECUCAO FINALIZADA (modo --console)");
            System.out.println("============================================================");
            return;
        }

        System.out.println("Abrindo interface grafica. Menu no terminal: mvn exec:java -Dexec.args=\"--console\"\n");
    ...
    public static void executarRequisitos(FuncionarioController controller) {
        System.out.println("------------------------------------------------------------");
        System.out.println(" 3.1 - INSERIR TODOS OS FUNCIONARIOS");
        System.out.println("------------------------------------------------------------\n");
        ...
        for (Funcionario f : inseridos) {
            ...
            System.out.printf("  [OK] Inserido: %s (ID: %d) | %s | R$ %s%n",
                    dto.getNome(), f.getId(), dto.getDataNascimentoFormatada(), dto.getSalarioFormatado());
        }
        System.out.println();

        System.out.println("------------------------------------------------------------");
        System.out.println(" 3.2 - REMOVER O FUNCIONARIO 'JOAO'");
        System.out.println("------------------------------------------------------------\n");
        controller.removerPorNome("João");
        System.out.println("  [OK] Funcionario 'Joao' removido.\n");
        ...
        System.out.println("------------------------------------------------------------");
        System.out.println(" 3.5/3.6 - AGRUPADOS POR FUNCAO (DTO)");
        System.out.println("------------------------------------------------------------\n");
        ...
        System.out.println("------------------------------------------------------------");
        System.out.println(" 3.9 - FUNCIONARIO MAIS VELHO (DTO)");
        System.out.println("------------------------------------------------------------\n");
        ...
        System.out.println("------------------------------------------------------------");
        System.out.println(" 3.10 - ORDEM ALFABETICA (DTO)");
        System.out.println("------------------------------------------------------------\n");
        int idx = 1;
        ...
        System.out.println("------------------------------------------------------------");
        System.out.println(" 3.12 - SALARIOS MINIMOS (DTO)");
    ...
    public static String executarRequisitosTexto(FuncionarioController controller) {
        ...
        sb.append("------------------------------------------------------------\n");
        sb.append("  DEMONSTRACAO 3.1 - 3.12 (DTO)\n");
        sb.append("------------------------------------------------------------\n\n");
        ...
        for (Funcionario f : inseridos) {
            FuncionarioDTO dto = controller.toDTO(f);
            sb.append(String.format("  [OK] %s | %s | R$ %s%n", dto.getNome(), dto.getDataNascimentoFormatada(), dto.getSalarioFormatado()));
        }
        sb.append("\n");

        sb.append("3.2 - Remover Joao\n");
        controller.removerPorNome("João");
        sb.append("  [OK] Removido.\n\n");
        ...
        sb.append("3.10 - Ordem alfabetica\n");
        int i = 1;
        for (FuncionarioDTO f : controller.listarPorOrdemAlfabeticaDTO()) {
        ...
        sb.append("3.12 - Salarios minimos\n");
        for (FuncionarioDTO f : controller.listarTodosDTO()) {
