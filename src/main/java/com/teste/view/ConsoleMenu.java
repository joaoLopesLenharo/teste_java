...
public final class ConsoleMenu {
    ...
    public static void executar(FuncionarioController controller) {
        ...
        while (true) {
            System.out.println();
            System.out.println("------------------------------------------------------------");
            System.out.println("  MODULO RH - MENU (requisitos do teste)");
            System.out.println("------------------------------------------------------------");
            System.out.println("  1 - Inserir funcionarios");
            System.out.println("  2 - Remover Joao");
            System.out.println("  3 - Listar todos");
            System.out.println("  4 - Aplicar aumento");
            System.out.println("  5 - Agrupar por funcao");
            System.out.println("  6 - Aniversariantes (10 e 12)");
            System.out.println("  7 - Funcionario mais velho");
            System.out.println("  8 - Ordenar alfabeticamente");
            System.out.println("  9 - Total salarios");
            System.out.println(" 10 - Salarios minimos");
            ...
            System.out.println(" 15 - Filtrar por funcao");
            System.out.println(" 16 - Filtrar aniversariantes por mes");
            System.out.println(" 17 - Demonstracao completa (3.1-3.12)");
    ...
    private static int lerMes(Scanner sc, int atual) {
        System.out.print("Mes para dashboard/export (1-12) [" + atual + "]: ");
        ...
        System.out.println("Valor invalido; usando " + atual + ".");
        return atual;
    }
    ...
    private static void opcaoRemoverJoao(FuncionarioController c) {
        ...
        System.out.println("\n[OK] Registros com nome 'Joao' removidos.\n");
    }
    ...
    private static void imprimirDashboard(FuncionarioController c, int mes) {
        ...
        System.out.println("\n------------ DASHBOARD ------------");
        System.out.println("Mes referencia aniversariantes: " + mes);
        System.out.println("Total de funcionarios: " + d.getTotalFuncionarios());
        System.out.println("Folha salarial: R$ " + d.getTotalFolha());
        System.out.println("Media salarial: R$ " + d.getMediaSalarial());
        ...
        System.out.println("Aniversariantes no mes " + mes + ":");
    ...
    private static void opcaoFiltroFuncao(Scanner sc, FuncionarioController c) {
        System.out.print("Funcao (ex.: Operador): ");
